...
//           // Add Path for Certification
//           {
//             path: "certifications",
//             element: <CertificationsTab />, // Wrapper for certifications management
//             children: [
//               { path: "", element: <CertificationsTable /> }, // View all certifications
//               { path: "add-certification", element: <AddCertifications /> }, // Add a new certification
//               { path: "edit-certification/:id", element: <EditCertifications /> }, // Edit an existing certification
//             ],
//           },
//         ],
//       },
